...
**Recorded:** 2026-08-04
**Subscription:** Visual Studio Enterprise Subscription (`<REDACTED_SUBSCRIPTION_ID>`)
...
|---|---|
| Name | `vpn-66` |
| Resource ID | `/subscriptions/<REDACTED_SUBSCRIPTION_ID>/resourceGroups/kwang-vpn/providers/Microsoft.Compute/virtualMachines/vpn-66` |
...
6. **Shared-fate risk.** This subscription also hosts other services. VPN bandwidth taking
   the credit to zero takes those down with it. The replacement should not share a
   billing boundary with other critical infrastructure.
